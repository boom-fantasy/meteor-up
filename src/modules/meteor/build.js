...
function buildMeteorApp(appPath, buildOptions, callback) {
    ...
    if(buildOptions.allow_reuse) {
        try {
            var stats = fs.lstatSync(buildOptions.buildLocation);
            if (stats.isDirectory()) {
                console.log('found old build');
            ...
            console.log('no build found, rebuilding');
        }
    }
